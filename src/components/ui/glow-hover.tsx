...
export default function GlowHover({
  ...
  const applyGlowStyles = (
    ...
    if (theme) {
      ...
      const brandColor = "#b2c73a"; // Hardcoding lime-500 since OKLCH might not be used here
      
      glowStyles = {
        borderColor: brandColor,
        boxShadow: `0 0 0 1px inset ${brandColor}, 0 0 20px rgba(178, 199, 58, ${glowIntensity})`,
        backgroundColor: `rgba(178, 199, 58, ${glowIntensity})`,
      };
    }
